...
CC = mpicc
OBJS = main.o parameterSetting.o findparam.o boundary.o loadBeam.o updateTotalEnergy.o saveFile.o saveParticleHDF.o saveFieldHDF.o particlePush.o rearrangeParticles.o updateK_quadG.o solveField.o fieldShareZ.o chicane.o clean.o wakeField.o selfseed.o loadSeed.o
